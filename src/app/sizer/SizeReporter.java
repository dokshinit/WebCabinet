...
import app.sizer.shared.SizeReporterRpc;
 ...
 * <p>
 * Note: the size is reported after headLayout is realized in the browser,
...
public class SizeReporter extends AbstractExtension {
    ...
    public boolean isConnectorEnabled() {
        return true; // we want to byId resize events for disabled components, too
    }
